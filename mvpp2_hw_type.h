...
#define MVPP2_CLS3_INIT_HIT_CNT_MASK		(((1 << MVPP2_CLS3_INIT_HIT_CNT_BITS) - 1) << MVPP2_CLS3_INIT_HIT_CNT_OFFS)
#define MVPP2_CLS3_INIT_HIT_CNT_MAX		((1 << MVPP2_CLS3_INIT_HIT_CNT_BITS) - 1)
...
#define MVPP2_CLS3_HASH_OP_TBL_ADDR_MASK	((MVPP2_CLS3_HASH_OP_TBL_ADDR_MAX) << MVPP2_CLS3_HASH_OP_TBL_ADDR)
...
#define MVPP2_CLS3_HASH_OP_EXT_TBL_ADDR_MASK	((MVPP2_CLS3_HASH_OP_EXT_TBL_ADDR_MAX) << MVPP2_CLS3_HASH_OP_EXT_TBL_ADDR)
...
#define MVPP2_CLS3_STATE_OCCIPIED_MASK		(((1 << MVPP2_CLS3_STATE_OCCIPIED_BITS) - 1) << MVPP2_CLS3_STATE_OCCIPIED)

#define MVPP2_CLS3_STATE_SC_STATE		16
#define MVPP2_CLS3_STATE_SC_STATE_BITS		2
#define MVPP2_CLS3_STATE_SC_STATE_MASK		(((1 << MVPP2_CLS3_STATE_SC_STATE_BITS) - 1) << MVPP2_CLS3_STATE_SC_STATE)
/*
SCAN STATUS
0 - scan compleat
1 -	hit counter clear
...
#define MVPP2_CLS3_STATE_NO_OF_SC_RES_MASK	(((1 << MVPP2_CLS3_STATE_NO_OF_SC_RES_BITS) - 1) << MVPP2_CLS3_STATE_NO_OF_SC_RES)
...
#define MVPP2_CLS3_HASH_DATA_REG(num)		(0x1CA0 + 4*(num)) /* 0-3 valid val*/
...
#define MVPP2_CLS3_CLEAR_COUNTERS_MASK		((MVPP2_CLS3_CLEAR_COUNTERS_MAX) << MVPP2_CLS3_CLEAR_COUNTERS)

#define MVPP2_CLS3_HIT_COUNTER_REG		0x1D08
#define MVPP2_CLS3_HIT_COUNTER			0
#define MVPP2_CLS3_HIT_COUNTER_BITS		24
#define MVPP2_CLS3_HIT_COUNTER_MAX		((1 << MVPP2_CLS3_HIT_COUNTER_BITS) - 1)
#define MVPP2_CLS3_HIT_COUNTER_MASK		((MVPP2_CLS3_HIT_COUNTER_MAX) << MVPP2_CLS3_HIT_COUNTER)

#define MVPP2_CLS3_SC_PROP_REG			0x1D10
#define MVPP2_CLS3_SC_PROP_TH_MODE		0
#define MVPP2_CLS3_SC_PROP_TH_MODE_MASK		(1 << MVPP2_CLS3_SC_PROP_TH_MODE)
#define MVPP2_CLS3_SC_PROP_CLEAR		1
#define MVPP2_CLS3_SC_PROP_CLEAR_MASK		(1 << MVPP2_CLS3_SC_PROP_CLEAR)
#define MVPP2_CLS3_SC_PROP_LKP_TYPE_EN		3
#define MVPP2_CLS3_SC_PROP_LKP_TYPE_EN_MASK	(1 << MVPP2_CLS3_SC_PROP_LKP_TYPE_EN)
#define MVPP2_CLS3_SC_PROP_LKP_TYPE		4
#define MVPP2_CLS3_SC_PROP_LKP_TYPE_BITS	6
#define MVPP2_CLS3_SC_PROP_LKP_TYPE_MAX		((1 << MVPP2_CLS3_SC_PROP_LKP_TYPE_BITS) - 1)
#define MVPP2_CLS3_SC_PROP_LKP_TYPE_MASK	((MVPP2_CLS3_SC_PROP_LKP_TYPE_MAX) << MVPP2_CLS3_SC_PROP_LKP_TYPE)
#define MVPP2_CLS3_SC_PROP_START_ENTRY		16
#define MVPP2_CLS3_SC_PROP_START_ENTRY_MASK	((MVPP2_CLS3_HASH_OP_TBL_ADDR_MAX) << MVPP2_CLS3_SC_PROP_START_ENTRY)

#define MVPP2_CLS3_SC_PROP_VAL_REG		0x1D14
#define MVPP2_CLS3_SC_PROP_VAL_DELAY		0
#define MVPP2_CLS3_SC_PROP_VAL_DELAY_BITS	16
#define MVPP2_CLS3_SC_PROP_VAL_DELAY_MAX	((1 << MVPP2_CLS3_SC_PROP_VAL_DELAY_BITS) - 1)
#define MVPP2_CLS3_SC_PROP_VAL_DELAY_MASK	(MVPP2_CLS3_SC_PROP_VAL_DELAY_MAX << MVPP2_CLS3_SC_PROP_VAL_DELAY)

#define MVPP2_CLS3_SC_TH_REG			0x1D18
#define MVPP2_CLS3_SC_TH			4
#define MVPP2_CLS3_SC_TH_BITS			20
#define MVPP2_CLS3_SC_TH_MAX			((1 << MVPP2_CLS3_SC_TH_BITS) - 1)
#define MVPP2_CLS3_SC_TH_MASK			(((1 << MVPP2_CLS3_SC_TH_BITS) - 1) << MVPP2_CLS3_SC_TH)

#define MVPP2_CLS3_SC_TIMER_REG			0x1D1c
#define MVPP2_CLS3_SC_TIMER			0
#define MVPP2_CLS3_SC_TIMER_BITS		16
#define MVPP2_CLS3_SC_TIMER_MASK		(((1 << MVPP2_CLS3_SC_TIMER_BITS) - 1) << MVPP2_CLS3_SC_TIMER)
...
#define MVPP2_CLS3_SC_RES_ENTRY_MASK		((MVPP2_CLS3_HASH_OP_TBL_ADDR_MAX) << MVPP2_CLS3_SC_RES_ENTRY)
#define MVPP2_CLS3_SC_RES_CTR			12
#define MVPP2_CLS3_SC_RES_CTR_MASK		((MVPP2_CLS3_HIT_COUNTER_MAX) << MVPP2_CLS3_SC_RES_CTR)
...
#define MVPP2_TXQ_WRR_BYTE_COUNT_MASK		(0x3FFFF << MVPP2_TXQ_WRR_BYTE_COUNT_OFFS)
