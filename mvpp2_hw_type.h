...
#define MVPP21_RXQ_CONFIG_REG(rxq)		(0x800 + 4 * (rxq))
#define MVPP21_SNOOP_PKT_SIZE_MASK		0x1ff
#define MVPP21_SNOOP_BUF_HDR_MASK		BIT(9)
#define MVPP21_RXQ_POOL_SHORT_OFFS		20
#define MVPP21_RXQ_POOL_SHORT_MASK		0x700000
#define MVPP21_RXQ_POOL_LONG_OFFS		24
#define MVPP21_RXQ_POOL_LONG_MASK		0x7000000
#define MVPP21_RXQ_PACKET_OFFSET_OFFS		28
#define MVPP21_RXQ_PACKET_OFFSET_MASK		0x70000000
#define MVPP21_RXQ_DISABLE_MASK			BIT(31)

#define MVPP22_RXQ_CONFIG_REG(rxq)		(0x800 + 4 * (rxq))
#define MVPP22_SNOOP_PKT_SIZE_MASK		0x1ff
#define MVPP22_SNOOP_BUF_HDR_MASK		BIT(9)
...
#define MVPP22_RXQ_PACKET_OFFSET_OFFS		28
#define MVPP22_RXQ_PACKET_OFFSET_MASK		0x70000000
#define MVPP22_RXQ_DISABLE_MASK			BIT(31)
...
#define MVPP22_ISR_TX_THRESHOLD_REG(rxq)	(0x5140 + 4 * (rxq))
#define MVPP2_ISR_RX_THRESHOLD_REG(rxq)		(0x5200 + 4 * (rxq))
#define MVPP21_ISR_RXQ_GROUP_REG(rxq)		(0x5400 + 4 * (rxq))
#define MVPP22_ISR_RXQ_GROUP_INDEX_REG(rxq)	(0x5400 + 4 * (rxq))
#define MVPP22_ISR_RXQ_GROUP_INDEX_SUBGROUP_MASK 0xf
#define MVPP22_ISR_RXQ_GROUP_INDEX_GROUP_MASK   0x380
#define MVPP22_ISR_RXQ_SUB_GROUP_CONFIG_REG(rxq)(0x5404 + 4 * (rxq))
...
#define MVPP21_ISR_RX_TX_CAUSE_REG(eth_port)	(0x5480 + 4 * (eth_port))
#define MVPP21_CAUSE_RXQ_OCCUP_DESC_ALL_MASK	0xffff
#define MVPP21_CAUSE_TXQ_OCCUP_DESC_ALL_MASK	0xff0000
#define MVPP21_CAUSE_RX_FIFO_OVERRUN_MASK	BIT(24)
#define MVPP21_CAUSE_FCS_ERR_MASK		BIT(25)
#define MVPP21_CAUSE_TX_FIFO_UNDERRUN_MASK	BIT(26)
#define MVPP21_CAUSE_TX_EXCEPTION_SUM_MASK	BIT(29)
#define MVPP21_CAUSE_RX_EXCEPTION_SUM_MASK	BIT(30)
#define MVPP21_CAUSE_MISC_SUM_MASK		BIT(31)
#define MVPP22_ISR_RX_TX_CAUSE_REG(eth_port)	(0x5480 + 4 * (eth_port))
#define MVPP22_CAUSE_RXQ_OCCUP_DESC_ALL_MASK	0x00ff
#define MVPP22_CAUSE_TXQ_OCCUP_DESC_ALL_MASK	0xff0000
#define MVPP22_CAUSE_RX_FIFO_OVERRUN_MASK	BIT(24)
#define MVPP22_CAUSE_FCS_ERR_MASK		BIT(25)
#define MVPP22_CAUSE_TX_FIFO_UNDERRUN_MASK	BIT(26)
#define MVPP22_CAUSE_TX_EXCEPTION_SUM_MASK	BIT(29)
#define MVPP22_CAUSE_RX_EXCEPTION_SUM_MASK	BIT(30)
#define MVPP22_CAUSE_MISC_SUM_MASK		BIT(31)
...
#define MVPP2_TX_BAD_FCS_CNTR_REG(eth_tx_port)	(0x8940 + ((eth_tx_port) << 2)) /* Same for PPv21/PPv22 */
#define MVPP2_TX_DROP_CNTR_REG(eth_tx_port)	(0x8980 + ((eth_tx_port) << 2)) /* Same for PPv21/PPv22 */


#define MVPP2_TX_ETH_DSEC_THRESH_REG(eth_tx_port)(0x8a40 + ((eth_tx_port) << 2))
#define MVPP2_TX_ETH_DSEC_THRESH_MASK		0x7f0

#define MVPP22_TX_EGR_PIPE_DELAY_REG(eth_tx_port)(0x8a80 + ((eth_tx_port) << 2))
