...
{
	pr_info("  %-45s: 0x%x = 0x%08x\n", reg_name, MV_PP3_PTP_UNIT_OFFSET + reg, mv_ptp_reg_read(reg));
}
...
{
	mv_ptp_reg_print("TAI_CTRL_REG0", MV_TAI_CTRL_REG0_REG);
	mv_ptp_reg_print("TAI_CTRL_REG1", MV_TAI_CTRL_REG1_REG);
	mv_ptp_reg_print("TIME_CNTR_FUNC_CFG_0", MV_TAI_TIME_CNTR_FUNC_CFG_0_REG);
	mv_ptp_reg_print("TIME_CNTR_FUNC_CFG_1", MV_TAI_TIME_CNTR_FUNC_CFG_1_REG);
	mv_ptp_reg_print("TIME_CNTR_FUNC_CFG_2", MV_TAI_TIME_CNTR_FUNC_CFG_2_REG);
	mv_ptp_reg_print("FREQUENCY_ADJUST_TIME_WINDOW", MV_TAI_FREQUENCY_ADJUST_TIME_WINDOW_REG);
	mv_ptp_reg_print("TOD_STEP_NANO_CFG", MV_TAI_TOD_STEP_NANO_CFG_REG);
	mv_ptp_reg_print("TOD_STEP_FRAC_CFG_HIGH", MV_TAI_TOD_STEP_FRAC_CFG_HIGH_REG);
	mv_ptp_reg_print("TOD_STEP_FRAC_CFG_LOW", MV_TAI_TOD_STEP_FRAC_CFG_LOW_REG);
	mv_ptp_reg_print("TIME_ADJUSTMENT_PROPAGATION_DELAY_CFG_HIGH",
		MV_TAI_TIME_ADJUSTMENT_PROPAGATION_DELAY_CFG_HIGH_REG);
	mv_ptp_reg_print("TIME_ADJUSTMENT_PROPAGATION_DELAY_CFG_LOW",
		MV_TAI_TIME_ADJUSTMENT_PROPAGATION_DELAY_CFG_LOW_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_SEC_HIGH", MV_TAI_TRIGGER_GENERATION_TOD_SEC_HIGH_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_SEC_MED", MV_TAI_TRIGGER_GENERATION_TOD_SEC_MED_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_SEC_LOW", MV_TAI_TRIGGER_GENERATION_TOD_SEC_LOW_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_NANO_HIGH", MV_TAI_TRIGGER_GENERATION_TOD_NANO_HIGH_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_NANO_LOW", MV_TAI_TRIGGER_GENERATION_TOD_NANO_LOW_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_FRAC_HIGH", MV_TAI_TRIGGER_GENERATION_TOD_FRAC_HIGH_REG);
	mv_ptp_reg_print("TRIGGER_GENERATION_TOD_FRAC_LOW", MV_TAI_TRIGGER_GENERATION_TOD_FRAC_LOW_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_SEC_HIGH", MV_TAI_TIME_LOAD_VALUE_SEC_HIGH_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_SEC_MED", MV_TAI_TIME_LOAD_VALUE_SEC_MED_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_SEC_LOW", MV_TAI_TIME_LOAD_VALUE_SEC_LOW_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_NANO_HIGH", MV_TAI_TIME_LOAD_VALUE_NANO_HIGH_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_NANO_LOW", MV_TAI_TIME_LOAD_VALUE_NANO_LOW_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_FRAC_HIGH", MV_TAI_TIME_LOAD_VALUE_FRAC_HIGH_REG);
	mv_ptp_reg_print("TIME_LOAD_VALUE_FRAC_LOW", MV_TAI_TIME_LOAD_VALUE_FRAC_LOW_REG);

	/* Read STATUS first since it is cleared after VALUExx reading */
	mv_ptp_reg_print("TIME_CAPTURE_STATUS", MV_TAI_TIME_CAPTURE_STATUS_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_SEC_HIGH", MV_TAI_TIME_CAPTURE_VALUE_0_SEC_HIGH_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_SEC_MED", MV_TAI_TIME_CAPTURE_VALUE_0_SEC_MED_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_SEC_LOW", MV_TAI_TIME_CAPTURE_VALUE_0_SEC_LOW_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_NANO_HIGH", MV_TAI_TIME_CAPTURE_VALUE_0_NANO_HIGH_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_NANO_LOW", MV_TAI_TIME_CAPTURE_VALUE_0_NANO_LOW_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_FRAC_HIGH", MV_TAI_TIME_CAPTURE_VALUE_0_FRAC_HIGH_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_0_FRAC_LOW", MV_TAI_TIME_CAPTURE_VALUE_0_FRAC_LOW_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_SEC_HIGH", MV_TAI_TIME_CAPTURE_VALUE_1_SEC_HIGH_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_SEC_MED", MV_TAI_TIME_CAPTURE_VALUE_1_SEC_MED_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_SEC_LOW", MV_TAI_TIME_CAPTURE_VALUE_1_SEC_LOW_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_NANO_HIGH", MV_TAI_TIME_CAPTURE_VALUE_1_NANO_HIGH_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_NANO_LOW", MV_TAI_TIME_CAPTURE_VALUE_1_NANO_LOW_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_FRAC_HIGH", MV_TAI_TIME_CAPTURE_VALUE_1_FRAC_HIGH_REG);
	mv_ptp_reg_print("TIME_CAPTURE_VALUE_1_FRAC_LOW", MV_TAI_TIME_CAPTURE_VALUE_1_FRAC_LOW_REG);

	mv_ptp_reg_print("TIME_UPDATE_CNTR_LSB", MV_TAI_TIME_UPDATE_CNTR_LSB_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_SEC_HIGH", MV_TAI_GENERATE_FUNCTION_MASK_SEC_HIGH_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_SEC_MED", MV_TAI_GENERATE_FUNCTION_MASK_SEC_MED_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_SEC_LOW", MV_TAI_GENERATE_FUNCTION_MASK_SEC_LOW_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_NANO_HIGH", MV_TAI_GENERATE_FUNCTION_MASK_NANO_HIGH_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_NANO_LOW", MV_TAI_GENERATE_FUNCTION_MASK_NANO_LOW_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_FRAC_HIGH", MV_TAI_GENERATE_FUNCTION_MASK_FRAC_HIGH_REG);
	mv_ptp_reg_print("GENERATE_FUNCTION_MASK_FRAC_LOW", MV_TAI_GENERATE_FUNCTION_MASK_FRAC_LOW_REG);
	mv_ptp_reg_print("DRIFT_ADJUSTMENT_CFG_HIGH", MV_TAI_DRIFT_ADJUSTMENT_CFG_HIGH_REG);
	mv_ptp_reg_print("DRIFT_ADJUSTMENT_CFG_LOW", MV_TAI_DRIFT_ADJUSTMENT_CFG_LOW_REG);
	mv_ptp_reg_print("CAPTURE_TRIGGER_CNTR", MV_TAI_CAPTURE_TRIGGER_CNTR_REG);
	mv_ptp_reg_print("PCLK_CLOCK_CYCLE_CFG_HIGH", MV_TAI_PCLK_CLOCK_CYCLE_CFG_HIGH_REG);
	mv_ptp_reg_print("PCLK_CLOCK_CYCLE_CFG_LOW", MV_TAI_PCLK_CLOCK_CYCLE_CFG_LOW_REG);
	mv_ptp_reg_print("DRIFT_THR_CFG_HIGH", MV_TAI_DRIFT_THR_CFG_HIGH_REG);
	mv_ptp_reg_print("DRIFT_THR_CFG_LOW", MV_TAI_DRIFT_THR_CFG_LOW_REG);
	mv_ptp_reg_print("CLOCK_CYCLE_CFG_HIGH", MV_TAI_CLOCK_CYCLE_CFG_HIGH_REG);
	mv_ptp_reg_print("CLOCK_CYCLE_CFG_LOW", MV_TAI_CLOCK_CYCLE_CFG_LOW_REG);
	mv_ptp_reg_print("EXT_CLOCK_PROPAGATION_DELAY_CFG_HIGH",
		MV_TAI_EXT_CLOCK_PROPAGATION_DELAY_CFG_HIGH_REG);
	mv_ptp_reg_print("EXT_CLOCK_PROPAGATION_DELAY_CFG_LOW",
		MV_TAI_EXT_CLOCK_PROPAGATION_DELAY_CFG_LOW_REG);
	mv_ptp_reg_print("INCOMING_CLOCKIN_CNTING_EN", MV_TAI_INCOMING_CLOCKIN_CNTING_EN_REG);
	mv_ptp_reg_print("INCOMING_CLOCKIN_CNTING_CFG_LOW", MV_TAI_INCOMING_CLOCKIN_CNTING_CFG_LOW_REG);
	mv_ptp_reg_print("TIME_UPDATE_CNTR_MSB", MV_TAI_TIME_UPDATE_CNTR_MSB_REG);
	mv_ptp_reg_print("INCOMING_CLOCKIN_CNTING_CFG_HIGH", MV_TAI_INCOMING_CLOCKIN_CNTING_CFG_HIGH_REG);
}
